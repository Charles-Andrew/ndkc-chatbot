...
def invalid_input():
    sample_responses = ["Im sorry, I only accept text.", "Sorry, I dont process other types except for texts.", "I cant do anything with that Iam Sorry :(", "I am not designed to handle that kind of input, Sorry :("]
